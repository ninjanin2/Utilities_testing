...
Version: 2.3 (Flash Attention Mock - Complete Fix)
...
# This section creates a mock flash_attn module to prevent import errors
# The model code tries to import flash_attn, but we don't need it

class FlashAttentionMock:
    """Mock module for flash_attn to prevent import errors"""

    def __getattr__(self, name):
        """Return a dummy function for any flash_attn attribute"""
        def dummy(*args, **kwargs):
            # Return None or empty tensors as needed
            return None
        return dummy

# Create mock modules before any other imports
sys.modules['flash_attn'] = FlashAttentionMock()
sys.modules['flash_attn.flash_attn_interface'] = FlashAttentionMock()
sys.modules['flash_attn.bert_padding'] = FlashAttentionMock()
sys.modules['flash_attn.flash_attn_triton'] = FlashAttentionMock()
...
logger.info("Flash Attention mock loaded successfully - no flash_attn required!")
...
class KeyeVLModel:
    ...
    def load_model(self):
        ...
        try:
            ...
            logger.info("Loading model (Flash Attention disabled via mock)...")
            ...
            logger.info("Flash Attention imports handled by mock module - no errors!")
    ...
    def create_interface(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Accordion("â„¹ï¸ System Information", open=False):
                ...
                â€¢ Flash Attention: Mocked (no installation required) âœ…<br>
                </div>
                """)
            ...
            <div style="text-align: center; color: #666; font-size: 0.9em;">
                ...
                <p>Flash Attention: Mocked (no flash-attn package required) âœ…</p>
            </div>
            """)
...
def main():
    ...
    try:
        logger.info("=" * 60)
        logger.info("Starting Keye-VL Video Analysis System v2.3")
        logger.info("=" * 60)
